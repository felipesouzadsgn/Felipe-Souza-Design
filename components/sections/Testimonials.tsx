            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {TESTIMONIALS.map((t, i) => (
                    <Reveal key={i} delay={i * 150}>
                        <div className="p-10 bg-white/5 backdrop-blur-sm border border-white/5 relative hover:bg-white/[0.07] hover:border-purple-500/30 transition-colors duration-300 group rounded-tl-3xl rounded-br-3xl rounded-tr-sm rounded-bl-sm">
