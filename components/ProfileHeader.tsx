...
const ProfileHeader: React.FC = () => {
    return (
        <div className="relative w-full flex flex-col items-center justify-center py-20 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-white dark:to-[#020202] pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <div className="flex items-center gap-1.5 mb-8">
                    <span className="text-gray-500 dark:text-gray-400 text-lg">@felipesouzadsgn</span>
                    <CheckCircle2 size={18} className="text-blue-500 fill-blue-500/10" />
                </div>

                {/* Bio */}
                <p className="max-w-xl text-gray-600 dark:text-gray-400 text-sm md:text-base leading-relaxed mb-10 px-4">
